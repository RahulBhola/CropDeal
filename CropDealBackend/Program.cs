...
builder.Services.AddScoped<IStripePaymentService, StripePaymentRepository>();
// builder.Services.AddScoped<IDealer, DealerRepository>();
builder.Services.AddScoped<IDealer, DealerRepository>();
builder.Services.AddScoped<IOrderTransaction, OrderTransactionRepository>();
builder.Services.AddScoped<IInvoice, InvoiceRepository>();
builder.Services.AddScoped<IAdminRepository, AdminRepository>();
// builder.Services.AddTransient<EmailService>();
builder.Services.AddScoped<EmailService>();
// builder.Services.Configure<EmailService>(builder.Configuration.GetSection(""));
