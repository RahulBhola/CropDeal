...
namespace CropDealBackend.Data
{
    public class CropDealDbContext: IdentityDbContext<ApplicationUser>{
        ...
        public DbSet<CropsInCart> CropsInCart{ get; set; }
        public DbSet<OrderTransaction> OrderTransactions { get; internal set; }
        public DbSet<Invoice> Invoices { get; internal set; }
    }
}